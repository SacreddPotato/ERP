...
class AdvanceLedger extends Component
{
    ...
    protected LedgerType $ledgerType = LedgerType::Advance;
    ...
    {
        $this->dispatch('show-delete-modal', type: 'advance', code: $code, name: $name);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.advance-ledger', [
            'entities' => $entities,
            'totals' => $totals,
