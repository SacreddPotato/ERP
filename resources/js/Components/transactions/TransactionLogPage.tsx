...
export default function TransactionLogPage() {
    ...
    const stockExportColumns: ColumnDef[] = [
        ...
        { key: 'quantity', label: t('th_quantity'), render: (v) => fmtInt(v), summable: true },
    ...
    const ledgerExportColumns: ColumnDef[] = [
        ...
        { key: 'debit', label: t('th_debit'), render: (v) => fmtNum(v), summable: true },
        { key: 'credit', label: t('th_credit'), render: (v) => fmtNum(v), summable: true },
